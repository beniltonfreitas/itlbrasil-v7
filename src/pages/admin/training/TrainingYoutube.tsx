...
import { Youtube, Trash2, ExternalLink, Loader2 } from "lucide-react";
import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import { useTrainingVideos } from "@/hooks/useTrainingVideos";
import { youtubeVideoSchema, type TrainingVideoFormData } from "@/schemas/trainingVideoSchema";

export const TrainingYoutube = () => {
  const { videos, isLoading, addVideo, deleteVideo, isAdding } = useTrainingVideos('youtube');
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-3xl font-bold">Treinamento - YouTube</h1>
      </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <Input 
                id="title"
                {...register('title')}
                placeholder="Ex: Como usar o painel admin" 
                className="mt-1" 
              />
              {errors.title && (
