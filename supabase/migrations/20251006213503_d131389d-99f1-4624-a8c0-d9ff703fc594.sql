...
DROP POLICY IF EXISTS "Superadmin can manage permissions" ON public.available_permissions;
DROP POLICY IF EXISTS "Superadmin can manage role permissions" ON public.role_permissions;
DROP POLICY IF EXISTS "Anyone can read permissions" ON public.available_permissions;
